...
class PDF extends FPDF
 ...
 //       $this->Cell(0,5,'(end of excerpt)');        
  ...
  $pdf->PrintChapter(1, 'The Advent of Arcs and Angels','pages/plaintext_01_preface_ooc.txt');     
  $pdf->PrintChapterNoTitle('pages/plaintext_01_ooc_enc.txt');
  ...
  $pdf->Output('../../_bin/advent_01/ltn.adventofarcs.01attachments.pdf');
  //$pdf->Output();
